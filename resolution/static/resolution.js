...
/*
 * Returns string.
 * Gets the value of the cookie with the given name or null.
 */
...
/*
 * Returns void.
 * The main function of our algorithm.
 * Determines browser via if-statements and calculates resolution accordingly.
 */
var onresize = function onresize() {
	...
	// Internet Explorer / Edge
		...
		hres = Math.round(screen.width * xzoom); // scaling resolution by zoom factor (x/y zoom)
	...
	// Chrome / Opera / Safari / other WebKit browsers
	else {
		pixelRatio = window.devicePixelRatio;
 ...
 * Runs our main function (onresize) at least once and sets other event handlers.
 */
onload = function() {
	if (isIE) {
